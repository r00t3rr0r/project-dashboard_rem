...
function renderProjectList(){
  ...
  projectsWithMeta.forEach(function(entry){
    ...
    if(gh.url){
      ...
      html+='<div class="project-e2e-block"><h5>GitHub E2E-Workflows</h5>'+renderProjectE2EWorkflows(project,canEdit)+'</div>';
...
function readProjectWorkflow(projectId,workflowId){
  var project=window.DataLayer.getProjectById(projectId);if(!project)return null;
  var workflows=Array.isArray(project.githubE2EWorkflows)?project.githubE2EWorkflows:[];
