...
function conceptOutputHint(){
  return 'Liefere nur die finale Antwort. Keine Analyse, keine Vorrede, kein Meta-Text. '; 
}

function technicalTaskOutputHint(){
  return 'Zerlege den Projektplan in technisch ausführbare Entwicklungsaufgabenschritte. Formuliere jede Aufgabe als klaren, umsetzbaren Task mit konkreter Aktion und eindeutigem Ergebnis. Keine Epics, kein Brainstorming, keine allgemeinen Arbeitspakete ohne Implementierungsbezug. ';
}
...
var DEFAULT_PRESETS={
  ...
  userstory:{
    ...
    templates:{
      ...
      tasks:'Du bist Product Owner und zerlegst den Plan in umsetzbare Arbeitspakete.\\n\\nStufe: 3 (Tasks)\\nProjekt: {{projectTitle}}\\nPreset: {{preset}}\\nSprache: {{language}}\\n\\nStufe 1 - Konzept:\\n{{conceptMarkdown}}\\n\\nStufe 2 - Projektplan:\\n{{planMarkdown}}\\n\\nMeeting-Notizen:\\n{{meetingNotes}}\\n\\nBestehende Projektdaten (JSON):\\n{{existingData}}\\n\\nGib ausschliesslich gueltiges JSON im Schema aus:\\n'+tasksJsonSchemaHint()+'\\nRegeln: fokus auf Nutzerwert, Akzeptanzkriterien in description integrieren, sequenceIndex fortlaufend und Abhaengigkeiten korrekt setzen.'
    }
  },
  custom:{
    key:'custom',
